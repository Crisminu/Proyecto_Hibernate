...
public class Persistencia {
    ...
    protected void configuracion() {
        final StandardServiceRegistry registro = new StandardServiceRegistryBuilder().configure("hibernate4.cfg.xml").build();
        try {
    ...
    protected void actualizar(int idSeguro, Scanner sc){
        es.cristina.hib4.Seguro seguro = new es.cristina.hib4.Seguro(idSeguro);
        Session sesion = sf.openSession();
        sesion.beginTransaction();
    ...
    public void datosEjemplo(){
        ...
        if (sesion.get(Seguro.class, 311) != null) {
            ...
            borrar(id);
            System.out.println("Datos de muestra borrados");
        }
        else {
            ...
            System.out.println("Datos de muestra añadidos");
        }
    ...
    public static void main(String[] args) {
        ...
        int opcion;
        while(acceso){
            System.out.println("Hibernate. Ejercicio 3 - Anotaciones");
